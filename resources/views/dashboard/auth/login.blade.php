...
<html lang="en">
  <head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="{{ asset('dashboard/assets/images/logo.jfif')}}" />
  </head>
  <body>
          ...
          <div class="row flex-grow">
            <div class="col-lg-6 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <h4>Hello! welcome to Reino Kids</h4>
                ...
                <form class="pt-3" method="POST" action="{{ route('admin.login') }}">
                  ...
                  <div class="mt-3 text-center">
                    <button type="submit" class="btn btn-block btn-lg font-weight-medium auth-form-btn">Login</button>
                  </div>
                  ...
                  <div class="text-center mt-4 font-weight-light"> Don't have an account? <a href="register.html" class="text-primary">Register</a>
                  </div>
                </form>
              </div>
            </div>
