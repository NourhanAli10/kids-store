                                    ...
                                    <div class="dash__pad-2">
                                        ...
                                        <form class="m-order u-s-m-b-30" method="GET" action="{{ route('orders') }}">
                                            <div class="m-order__select-wrapper">
                                                    ...
                                                    <select class="select-box select-box--primary-style" onchange="this.form.submit()" name="filter" id="my-order-sort">
                                                        <option></option>
                                                        <option value="5" {{ request('filter') == '5' ? 'selected' : ''}} >Last 5 orders</option>
