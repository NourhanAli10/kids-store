                        ...
                        <div class="about">
                            <div class="about__container">
                                <div class="about__info">
                                    <h2 class="about__h2">Welcome to Reino Kids Store!</h2>
                                    <div class="about__p-wrap">
                                        <p class="about__p">
                                            At Reino, we believe childhood is a magical time, and we’re here to make it even more special. Our store offers a thoughtfully curated selection of stylish and comfortable clothing for kids of all ages, fun and educational toys that inspire creativity and learning, and trendy accessories to add the perfect touch to any outfit.

                                            We are committed to providing high-quality, safe, and affordable products that parents can trust and kids will love. Whether you’re shopping for everyday essentials or special occasions, Reino Kid Store has everything you need to make your little one smile.

                                            Thank you for choosing Reino — where happiness meets style!
                                        </p>
                                    </div>
                                ...
                                <div class="team-member__social-wrap">
                                    <ul class="team-member__social-list">
                                        <li>
                                            ...
                                            <a class="s-tw--bgcolor-hover" href="#"><i class="fab fa-twitter"></i></a>
                                        </li>
                                        <li>
