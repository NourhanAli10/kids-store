<div class="col-lg-3 col-md-12">
    ...
    <div class="dash__box dash__box--bg-white dash__box--shadow u-s-m-b-30">
        <div class="dash__pad-1">
            ...
            <span class="dash__text u-s-m-b-16">Hello, {{ Auth::user()->first_name }}</span>
            <ul class="dash__f-list">
                <li>

                    <a class="dash-active" href="{{ route('account') }}">Manage My Account</a>
                </li>
                <li>
                ...
                <li>
                    ...
                    <a href="{{ route('address.show') }}">Address Book</a>
                </li>
                <li>
