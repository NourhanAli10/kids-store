                                ...
                                <div class="dash-l-r">
                                    ...
                                    <div>
                                        <div class="manage-o__text-2 u-c-silver">Total:
                                            ...
                                            <span class="manage-o__text-2 u-c-secondary"> EGP {{ number_format($order->subtotal + $order->tax_amount + $order->shippingCost )}} </span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white u-s-m-b-30">
                            <div class="dash__pad-2">
                                <div class="manage-o">
                                    ...
                                    <div class="dash-l-r">
                                        <div class="manage-o__text u-c-secondary">{{ $order->status }}</div>
                                        ...
                                        <div class="description__info-wrap">
                                            ...
                                            <div>
                                                ...
                                                <span class="manage-o__text-2 u-c-silver">Total:
                                                    ...
                                                    <span class="manage-o__text-2 u-c-secondary">EGP {{ $item->total_price }}</span></span>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
                            ...
                            <div class="col-lg-6">
                                <div class="dash__box dash__box--bg-white dash__box--shadow u-s-m-b-30">
                                    <div class="dash__pad-3">
                                        ...
                                        <h2 class="dash__h2 u-s-m-b-8 ">{{ $order->shipping_first_name }} {{ $order->shipping_last_name }}</h2>

                                        <span class="dash__text-2">{{ $order->shipping_address }}</span>

                                        <span class="dash__text-2">{{ $order->shipping_phone}}</span>
                                    </div>
                                </div>
                                ...
                                <div class="dash__box dash__box--bg-white dash__box--shadow u-h-100">
                                    <div class="dash__pad-3">
                                        ...
                                        <div class="dash-l-r u-s-m-b-8">
                                            ...
                                            <div class="manage-o__text-2 u-c-secondary">EGP {{ $order->subtotal }}</div>
                                        </div>
                                        <div class="dash-l-r u-s-m-b-8">
                                            <div class="manage-o__text-2 u-c-secondary">Tax </div>
                                            <div class="manage-o__text-2 u-c-secondary">EGP {{ $order->tax_amount }}</div>
                                        </div>
                                        <div class="dash-l-r u-s-m-b-8">
                                            <div class="manage-o__text-2 u-c-secondary">Shipping Fee</div>
                                            <div class="manage-o__text-2 u-c-secondary">EGP {{ $order->shipping_cost }}</div>
                                        </div>
                                        <div class="dash-l-r u-s-m-b-8">
                                            <div class="manage-o__text-2 u-c-secondary">Total</div>
                                            <div class="manage-o__text-2 u-c-secondary">EGP {{ number_format($order->subtotal + $order->tax_amount + $order->shippingCost )}}</div>
                                        </div>

                                        <span class="dash__text-2">Paid by {{ str_replace('_', ' ', $order->payment_method) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
