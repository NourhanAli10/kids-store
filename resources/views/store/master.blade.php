                                        ...
                                        <div id="js-product-detail-modal">
                                            <div>
                                                ...
                                                <img class="u-img-fluid"
                                                    src="{{ asset('store_assets/images/product/product-d-1.jpg') }}"
                                                    alt="">
                                            </div>
                                            <div>

                                                <img class="u-img-fluid"
                                                    src="{{ asset('store_assets/images/product/product-d-2.jpg') }}"
                                                    alt="">
                                            </div>
                                            <div>

                                                <img class="u-img-fluid"
                                                    src="{{ asset('store_assets/images/product/product-d-3.jpg') }}"
                                                    alt="">
                                            </div>
                                            <div>

                                                <img class="u-img-fluid"
                                                    src="{{ asset('store_assets/images/product/product-d-4.jpg') }}"
                                                    alt="">
                                            </div>
                                            <div>

                                                <img class="u-img-fluid"
                                                    src="{{ asset('store_assets/images/product/product-d-5.jpg') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="success u-s-m-b-30">
                                    ...
                                    <div class="success__img-wrap">
                                        ...
                                        <img class="u-img-fluid"
                                            src="{{ asset('store_assets/images/product/electronic/product1.jpg') }}"
                                            alt="">
                                    </div>
                            ...
                            <div class="col-lg-6 new-l__col-1 u-s-p-x-0">
                                ...
                                <a class="new-l__img-wrap u-d-block" href="shop-side-version-2.html">
                                    ...
                                    <img class="u-img-fluid u-d-block"
                                        src="{{ asset('store_assets/images/newsletter/newsletter.jpg') }}"
                                        alt=""></a>
                            </div>
